...
module Quasiquote.Core.Term where
...
data TermParenLoc
  ...
  | RecDotArg
  | QuotedArg | QuoteArg | UnquoteBody
  deriving (Eq)

instance ParenLoc Term where
  type Loc Term = TermParenLoc
  parenLoc (Meta _)
    = [AnnLeft,FunArg,FunRet,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (Var _)
    = [AnnLeft,FunArg,FunRet,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  ...
  parenLoc (AbsoluteDottedVar _ _)
    = [AnnLeft,FunArg,FunRet,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (Ann _ _)
    = [FunArg,FunRet,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc Type
    = [AnnLeft,FunArg,FunRet,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (Fun _ _ _)
    = [FunArg,FunRet,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (Lam _ _)
    = [FunArg,FunRet,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (App _ _ _)
    = [FunArg,FunRet,AnnLeft,LamBody,AppLeft,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (Con _ [])
    = [FunArg,FunRet,AnnLeft,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (Con _ _)
    = [FunArg,FunRet,AnnLeft,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (Case _ _ _)
    = [FunArg,FunRet,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (RecordType _)
    = [FunArg,FunRet,AnnLeft,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (RecordCon _)
    = [FunArg,FunRet,AnnLeft,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (RecordDot _ _)
    = [AnnLeft,FunArg,FunRet,LamBody,AppLeft,ExplAppRight,ImplAppRight,ExplConArg,ImplConArg,AssertionPatArg,RecDotArg,QuotedArg,QuoteArg,UnquoteBody]
  parenLoc (Quoted _)
    = [FunArg,FunRet,AnnLeft,AnnRight,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (Quote _)
    = [FunArg,FunRet,AnnLeft,AnnRight,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
  parenLoc (Unquote _ _)
    = [FunArg,FunRet,AnnLeft,AnnRight,LamBody,ImplAppRight,ImplConArg,UnquoteBody]
...
instance ParenRec Term where
  ...
  parenRec (Quoted a)
    = "Quoted " ++ parenthesize (Just QuotedArg) a
  parenRec (Quote m)
    = "quote " ++ parenthesize (Just QuoteArg) m
  parenRec (Unquote m sc)
    = "unquote " ++ parenthesize Nothing m ++ " as " ++ unwords (names sc)
   ++ " in " ++ parenthesize (Just UnquoteBody) (descope (Var . Name) sc)
...
metas x = nub (go x)
  where
    ...
    go (Quoted a) = go a
    go (Quote m) = go m
    go (Unquote m sc) = go m ++ go (descope (Var . Name) sc)
