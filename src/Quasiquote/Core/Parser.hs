...
languageDef = Token.LanguageDef
              ...
              , Token.reservedNames = ["data","case","motive","of","end","where"
                                      ...
                                      ,"Rec","family","instance","Quoted","quote","unquote"
                                      ]
...
quote = do _ <- try $ reserved "quote"
           m <- quoteArg
           return $ Quote m

unquote = do _ <- try $ reserved "unquote"
             m <- term
             _ <- reserved "as"
             x <- varName
             _ <- reserved "in"
             b <- unquoteBody
             return $ unquoteHelper m x b
                       

parenTerm = parens term

annLeft = application <|> dottedThings <|> parenTerm <|> conData <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote

annRight = application <|> dottedThings <|> funType <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote

funArg = application <|> dottedThings <|> parenTerm <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote

funRet = annotation <|> funType <|> application <|> dottedThings <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote

lamBody = annotation <|> funType <|> application <|> dottedThings <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote
...
rawImplAppArg = annotation <|> funType <|> application <|> dottedThings <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote
...
rawImplConArg = annotation <|> funType <|> application <|> dottedThings <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote
...
quotedArg = dottedThings <|> parenTerm <|> variable <|> typeType <|> noArgConData <|> recordType <|> recordCon

quoteArg = dottedThings <|> parenTerm <|> variable <|> typeType <|> noArgConData <|> recordType <|> recordCon

unquoteBody = annotation <|> funType <|> application <|> dottedThings <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote

term = annotation <|> funType <|> application <|> dottedThings <|> parenTerm <|> lambda <|> conData <|> caseExp <|> variable <|> typeType <|> recordType <|> recordCon <|> quotedType <|> quote <|> unquote
